...
Roep de qmd MCP `query` tool aan met minimaal twee sub-queries:
...
**5.5 — Roep qmd update aan via MCP**

Roep de qmd MCP `update` tool aan zodat de nieuwe pagina direct doorzoekbaar is.
